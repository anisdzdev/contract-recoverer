...
export async function deploy() {
    ...
    const Contract = await ethers.getContractFactory('MoveETH');
    // @ts-ignore
    const contract = await Contract.deploy(...ContractArguments, { value: CollectionConfig.contractValue }) as MoveETH;
